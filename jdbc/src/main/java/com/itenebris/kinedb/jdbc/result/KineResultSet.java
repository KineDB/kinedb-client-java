...
public class KineResultSet implements ResultSet {
	...
	public KineResultSet(ResultData data, KineConnection connection) {
		this.data = data;
		currentRow = -1;
...
//						}
	...
	protected boolean hasRows() {
		return this.data != null && this.getData().rowNames != null;
	...
	public String toString() {
		return "KineResultSet{" +
				...
				", defaultTimestampFormatter=" + defaultTimestampFormatter +
				", connection=" + connection +
				", statement=" + statement +
				", data=" + data +
				", thisRow=" + Arrays.toString(thisRow) +
