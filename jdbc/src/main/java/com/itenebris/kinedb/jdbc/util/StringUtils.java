...
public class StringUtils {
    ...
    public static byte[] getBytes(String s, String encoding) {
        if (s == null) {
            ...
            try {
                ...
                log.error("Unsupported character encoding  " + new Object[]{encoding}, var3);
            }
        }
        return new byte[0];
    }
    ...
    public static String toString(byte[] value, int offset, int length, String encoding) {
        if (encoding != null && !"null".equalsIgnoreCase(encoding)) {
            try {
                ...
                //throw (WrongArgumentException)ExceptionFactory.createException(WrongArgumentException.class, Messages.getString("StringUtils.0", new Object[]{encoding}), var5);
            }
            return null;
        } else {
    ...
    public static String toString(byte[] value, String encoding) {
        if (encoding == null) {
            ...
            try {
                ...
                //throw (WrongArgumentException)ExceptionFactory.createException(WrongArgumentException.class, Messages.getString("StringUtils.0", new Object[]{encoding}), var3);
            }
        }
        return null;
    }
    ...
    public static byte[] getBytes(char[] value, int offset, int length, String encoding) {
        ...
        try {
            ...
            //throw (WrongArgumentException)ExceptionFactory.createException(WrongArgumentException.class, Messages.getString("StringUtils.0", new Object[]{encoding}), var8);
        }
    ...
    public static final void hexEscapeBlock(byte[] buf, int size, BiConsumer<Byte, Byte> bc) {
        for(int i = 0; i < size; ++i) {
            bc.accept((byte)HEX_DIGITS[buf[i] >>> 4 & 15], (byte)HEX_DIGITS[buf[i] & 15]);
        }
    ...
    public static boolean canHandleAsServerPreparedStatementNoCache(String sql, boolean allowMultiQueries, boolean noBackslashEscapes, boolean useAnsiQuotes) {
        if (startsWithIgnoreCaseAndNonAlphaNumeric(sql, "CALL")) {
            ...
            if (allowMultiQueries) {
                ...
                canHandleAsStatement = false;
            } else if (startsWithIgnoreCaseAndWs(sql, "SHOW WARNINGS")) {
                canHandleAsStatement = false;
